...
#Region "Properties"
    ...
    Public Property GoldROI() As Integer
        Get
            Return _intROI
        End Get
        Set(ByVal Value As Integer)
...
#Region "Functions"
    ...
    Public Function fnAddGLAccount(ByVal objTrans As IDbTransaction) As Boolean
        ...
        If fnCheckPerson() Then
            If fnUpdatePerson(objTrans) Then
                Return fnInsertGLAccount(objTrans)
            End If
        Else
    ...
    Private Function fnInsertGLAccount(ByVal objTrans As IDbTransaction) As Boolean
        ...
        strSQL = "Insert into loanDetailstbl(LoanNo,PersonNo,MemberNo,SBNo,ExpAmount,SancAmount,DisbAmount,ApplDate,SancDate,DueDate,ROI,NOI,InstPrinciple,RepayMode,Purpose,LastPaidDate,Remarks,status,ReceiptNo)"
        strSQL = strSQL & " values('" & _strGoldNo & "','" & _lngPersonNo & "','" & _strMemberNo & "','" & _strSBNo & "','" & _intExpectedAmount & "','" & _intSanctionedAmount & "','" & _intDisbAmt & "','" & Format(_datGoldDate, "yyyy-MM-dd") & "','" & Format(_datGoldDate, "yyyy-MM-dd") & "','" & Format(_datDueDate, "yyyy-MM-dd") & "','" & _intROI & "','" & _intNOI & "','" & _intInstPrinciple & "','" & _strModeOfPayment & "','" & _strReason & "','" & Format(_datLastPaid, "yyyy-MM-dd") & "','" & _strRemarks & "','" & _strStatus & "','" & _strReciptNo & "')"
        Return fnExecuteNonQuery(strSQL, objTrans)
    End Function

    Private Function fnInsertWitnessDet(ByVal objTrans As IDbTransaction) As Boolean

        strSQL = "Insert into goldloandetailstbl (GoldLoanNo,MemberNo,PersonNo,GoldAmount,InstallmentType,WitnessPerson1,Address1,WitnessPerson2,Address2)"
        strSQL = strSQL & " values('" & _strGoldNo & "','" & _strMemberNo & "','" & _lngPersonNo & "','" & _intGoldAmt & "','" & _strInstallment & "','" & _strWitnessPerson1 & "','" & _strWitnessAddress1 & "','" & _strWitnessPerson2 & "','" & _strWitnessAddress2 & "')"
        Return fnExecuteNonQuery(strSQL, objTrans)
    ...
    Public Function fnCheckGoldAccount(ByVal strGLNo As String) As Boolean
        ...
        strSQL = "SELECT * FROM goldDetailstbl WHERE goldLoanNo='" & strGLNo & "'"
    ...
    Public Function fnUpdateGLAccount(ByVal strGLno As String) As Boolean

        If fnUpdatePerson() Then

            strSQL = "UPDATE loandetailsTbl SET memberNo = '" & _strMemberNo & "',personNo = '" & _lngPersonNo & "', sbno = '" & _strSBNo & "', expAmount='" & _intExpectedAmount & "', sancamount='" & _intSanctionedAmount & "',ApplDate = '" & Format(_datGoldDate, "yyyy-MM-dd") & "',DueDate = '" & Format(_datDueDate, "yyyy-MM-dd") & "', RepayMode  ='" & _strModeOfPayment & "' , ROI='" & _intROI & "',NOI = '" & _intNOI & "',InstPrinciple = '" & _intInstPrinciple & "',Purpose ='" & _strReason & "', Remarks = '" & _strRemarks & "'   WHERE  LoanNo='" & strGLno & "'"
    ...
    Public Function fnUpdateGLWitnessDet() As Boolean

        strSQL = " update goldloanDetailstbl set memberNo = '" & _strMemberNo & "',personNo = '" & _lngPersonNo & "', GoldAmount = '" & _intGoldAmt & "',InstallmentType = '" & _strInstallment & "', witnessPerson1 = '" & _strWitnessPerson1 & "', WitnessPerson2 = '" & _strWitnessPerson2 & "', Address1 = '" & _strWitnessAddress1 & "', Address2 = '" & _strWitnessAddress2 & "' where goldloanNo = '" & _strGoldNo & "'"
    ...
    Public Function fnDeleteGLItemsAccount(ByVal strGLno As String) As Boolean
        Dim dr As DataRow

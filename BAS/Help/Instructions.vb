Public NotInheritable Class Instructions

    Private Shared m_FormDefInstance As Instructions
    Private Shared m_InitializingDefInstance As Boolean
    Public Shared Property DefInstance() As Instructions
        Get
            If m_FormDefInstance Is Nothing OrElse m_FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_FormDefInstance = New Instructions
                m_InitializingDefInstance = False
            End If
            DefInstance = Instructions
        End Get
        Set(ByVal Value As Instructions)

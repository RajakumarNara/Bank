...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lvHomeCust.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.lvHomeCust.FullRowSelect = True
        Me.lvHomeCust.GridLines = True
        Me.lvHomeCust.Location = New System.Drawing.Point(8, 128)
        Me.lvHomeCust.MultiSelect = False
        Me.lvHomeCust.Name = "lvHomeCust"
        Me.lvHomeCust.Size = New System.Drawing.Size(432, 304)
        ...
        Me.Name = "frmHandLoanCust"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Hand Loan Search"
...
#Region "Varaibles"
    ...
    Dim objHandLaonCust As New clsHandLoan
    Dim dvHandLoan As DataView
    Dim strFilter As String = "Name like '%'"
    Public strHandLoan As String

#End Region

#Region "Function"

    Public Function fnGetHandLoan() As Boolean

        Dim intCount As Integer = 0
        Dim lstvMedium As ListViewItem

        If Not dvHandLoan Is Nothing Then

            dvHandLoan.RowFilter = strFilter
            lvHomeCust.Items.Clear()
            lblMessage.Text = "There are " & dvHandLoan.Count & " records found for your search"

            While intCount < dvHandLoan.Count
                lstvMedium = lvHomeCust.Items.Add(dvHandLoan.Item(intCount).Item("LoanNo"))
                lstvMedium.SubItems.Add(dvHandLoan.Item(intCount).Item("Name"))
                intCount += 1
            End While
...
#End Region
    ...
    Private Sub frmGoldLoanCust_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If objHandLaonCust.fnGetHandLoanCust = True Then
            dvHandLoan = New DataView(objHandLaonCust.HandLoanCusttable, strFilter, "Name", DataViewRowState.OriginalRows)
            fnGetHandLoan()
        End If
    End Sub
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click, lvHomeCust.DoubleClick
        If lvHomeCust.Items.Count > 0 Then
            If lvHomeCust.SelectedItems.Count > 0 Then
                strHandLoan = lvHomeCust.SelectedItems(0).SubItems(0).Text
                Me.Close()
            Else

...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents lvSMTLLoan As System.Windows.Forms.ListView
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lvSMTLLoan = New System.Windows.Forms.ListView
        ...
        'lvSMTLLoan
        '
        Me.lvSMTLLoan.AllowColumnReorder = True
        Me.lvSMTLLoan.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.ColumnHeader1, Me.ColumnHeader2})
        Me.lvSMTLLoan.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.lvSMTLLoan.FullRowSelect = True
        Me.lvSMTLLoan.GridLines = True
        Me.lvSMTLLoan.HideSelection = False
        Me.lvSMTLLoan.Location = New System.Drawing.Point(8, 144)
        Me.lvSMTLLoan.MultiSelect = False
        Me.lvSMTLLoan.Name = "lvSMTLLoan"
        Me.lvSMTLLoan.Size = New System.Drawing.Size(432, 296)
        Me.lvSMTLLoan.Sorting = System.Windows.Forms.SortOrder.Ascending
        Me.lvSMTLLoan.TabIndex = 4
        Me.lvSMTLLoan.UseCompatibleStateImageBehavior = False
        Me.lvSMTLLoan.View = System.Windows.Forms.View.Details
        '
        'ColumnHeader1
        '
        ...
        Me.Controls.Add(Me.lvSMTLLoan)
        Me.Controls.Add(Me.Panel1)
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.Name = "frmODLoanCust"
...
#Region "Varaibles"
    ...
    Dim objclsSMTLDetails As New clsSMTLLoan
    Dim dvSMTLLoan As DataView
    Dim strFilter As String = "Name like '%'"
    Public strSMTLLoan As String

#End Region

#Region "Function"

    Public Function fnGetSMTLLoan() As Boolean
        Dim intCount As Integer = 0
        Dim lstvSMTL As ListViewItem
        If Not dvSMTLLoan Is Nothing Then
            dvSMTLLoan.RowFilter = strFilter
            lvSMTLLoan.Items.Clear()
            lblMessage.Text = "There are " & dvSMTLLoan.Count & " records found for your search"
            While intCount < dvSMTLLoan.Count
                lstvSMTL = lvSMTLLoan.Items.Add(dvSMTLLoan.Item(intCount).Item("AccountNo"))
                lstvSMTL.SubItems.Add(dvSMTLLoan.Item(intCount).Item("Name"))
                intCount += 1
            End While
        End If
    End Function
...
#End Region
    ...
    Private Sub frmGoldLoanCust_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If objclsSMTLDetails.fnGetSMTLLoanCust = True Then
            dvSMTLLoan = New DataView(objclsSMTLDetails.OverDraftLoanCusttable, strFilter, "Name", DataViewRowState.OriginalRows)
            fnGetSMTLLoan()
        End If
    End Sub
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click, lvSMTLLoan.DoubleClick
        If lvSMTLLoan.Items.Count > 0 Then
            If lvSMTLLoan.SelectedItems.Count > 0 Then
                strSMTLLoan = lvSMTLLoan.SelectedItems(0).SubItems(0).Text
                Me.Close()
            Else
    ...
    Private Sub lvSMTLLoan_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles lvSMTLLoan.KeyDown
    ...
    Private Sub txtSearch_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSearch.KeyDown
        If e.KeyData = Keys.Down Then
            lvSMTLLoan.Focus()
            If lvSMTLLoan.Items.Count > 0 Then
                lvSMTLLoan.Items(0).Selected = True
                lvSMTLLoan.Select()
            End If
        End If
    End Sub

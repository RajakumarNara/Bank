Public Class frmSuretyLoanCust
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "frmSuretyLoanCust"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Secured Loan Search"
...
#Region "Varaibles"
    ...
    Dim objSuretyLaonCust As New clsHandLoan
    Dim dvSuretyLoan As DataView
    Dim strFilter As String = "Name like '%'"
    Public strSuretyLoan As String

#End Region

#Region "Function"

    Public Function fnGetSuretyLoan() As Boolean
        Dim intCount As Integer = 0
        Dim lstvMedium As ListViewItem
        If Not dvSuretyLoan Is Nothing Then
            dvSuretyLoan.RowFilter = strFilter
            lvHomeCust.Items.Clear()
            lblMessage.Text = "There are " & dvSuretyLoan.Count & " records found for your search"
            While intCount < dvSuretyLoan.Count
                lstvMedium = lvHomeCust.Items.Add(dvSuretyLoan.Item(intCount).Item("LoanNo"))
                lstvMedium.SubItems.Add(dvSuretyLoan.Item(intCount).Item("Name"))
                intCount += 1
            End While
        End If
    End Function
...
#End Region
    ...
    Private Sub frmSuretyLoanCust_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbType.SelectedIndex = 0
        If objSuretyLaonCust.fnGetSuretyLoanCust = True Then
            dvSuretyLoan = New DataView(objSuretyLaonCust.HandLoanCusttable, strFilter, "Name", DataViewRowState.OriginalRows)
            fnGetSuretyLoan()
        End If
    End Sub
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click, lvHomeCust.DoubleClick
        If lvHomeCust.Items.Count > 0 Then
            If lvHomeCust.SelectedItems.Count > 0 Then
                strSuretyLoan = lvHomeCust.SelectedItems(0).SubItems(0).Text
                Me.Close()
            Else

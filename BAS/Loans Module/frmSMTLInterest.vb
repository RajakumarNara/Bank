...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSMTLdayend))
        ...
        Me.Name = "frmSMTLdayend"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "SMTL Interest"
...
#End Region
    ...
    Function fnGenerateVoucherInt(ByVal AccountNo As String, ByVal TrDate As Date, ByVal Interest As Double, ByVal intReceiptNo As Integer, ByVal Balance As Double) As Boolean
        ...
        strsql = strsql & " select '" & Trim(AccountNo) & "','" & Format(TrDate, "yyyy-MM-dd:HH:mm:ss") & "','" & strNarration & "' ,'0','" & Interest & "',sum(withdraw)-sum(Deposit)+'" & Interest & "','" & Interest & "','" & Interest & "','" & Interest & "','" & intReceiptNo & "','" & lngVoucherNo & "','Cash','0' from SMTLtransactiontbl where accountno='" & AccountNo & "' group by Accountno"
    ...
    Private Sub frmSMTLdayend_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

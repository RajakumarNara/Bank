Public Class frmDailyRecoveryLoanCust
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "frmDailyRecoveryLoanCust"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Daily Recovery Loan Details"
...
#Region "Varaibles"
    ...
    Dim objDRLaonCust As New clsDailyRecoveryLoan
    Dim dvDRLoan As DataView
    Dim strFilter As String = "Name like '%'"
    Public strLoan As String

#End Region

#Region "Function"

    Public Function fnGetDRLoan() As Boolean

        Dim intCount As Integer = 0
        Dim lstvMedium As ListViewItem

        If Not dvDRLoan Is Nothing Then

            dvDRLoan.RowFilter = strFilter
            lvHomeCust.Items.Clear()
            lblMessage.Text = "There are " & dvDRLoan.Count & " records found for your search"

            While intCount < dvDRLoan.Count
                lstvMedium = lvHomeCust.Items.Add(dvDRLoan.Item(intCount).Item("LoanNo"))
                lstvMedium.SubItems.Add(dvDRLoan.Item(intCount).Item("Name"))
                intCount += 1
            End While
...
#End Region
    ...
    Private Sub frmGoldLoanCust_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If objDRLaonCust.fnGetDRLoanCust() = True Then
            dvDRLoan = New DataView(objDRLaonCust.DRLoanCusttable, strFilter, "Name", DataViewRowState.OriginalRows)
            fnGetDRLoan()
        End If
    End Sub
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click, lvHomeCust.DoubleClick
        If lvHomeCust.Items.Count > 0 Then
            If lvHomeCust.SelectedItems.Count > 0 Then
                strLoan = lvHomeCust.SelectedItems(0).SubItems(0).Text
                Me.Close()
            Else

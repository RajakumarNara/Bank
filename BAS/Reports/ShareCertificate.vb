...
Public Class ShareCertificate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.ShareCertificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MemberNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedShareCertificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShareCertificate = New ShareCertificate()
        rpt.Site = Me.Site
        Return rpt
    End Function

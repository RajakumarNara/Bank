...
Public Class ReciptAndPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.ReciptAndPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciptAndPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciptAndPayment = New ReciptAndPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function

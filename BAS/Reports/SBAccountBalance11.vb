...
Public Class SBAccountBalance1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.SBAccountBalance1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSBAccountBalance1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SBAccountBalance1 = New SBAccountBalance1()
        rpt.Site = Me.Site
        Return rpt
    End Function

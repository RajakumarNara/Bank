...
Public Class MemberLabelPrint1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.MemberLabelPrint1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMemberLabelPrint1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MemberLabelPrint1 = New MemberLabelPrint1()
        rpt.Site = Me.Site
        Return rpt
    End Function

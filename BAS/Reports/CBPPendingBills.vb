...
Public Class CBPPendingBills
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.CBPPendingBills.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CBPBillDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCBPPendingBills
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CBPPendingBills = New CBPPendingBills()
        rpt.Site = Me.Site
        Return rpt
    End Function

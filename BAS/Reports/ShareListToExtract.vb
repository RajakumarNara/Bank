...
Public Class ShareListToExtract
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.ShareListToExtract.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShareListToExtract
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShareListToExtract = New ShareListToExtract()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class ReciptAndPayment2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.ReciptAndPayment2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciptAndPayment2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciptAndPayment2 = New ReciptAndPayment2()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class PassBookHomePage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.PassBookHomePage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPassBookHomePage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PassBookHomePage = New PassBookHomePage()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class BankAndPersonDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BankAndPersonDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BAS.BankAndPersonDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AccountNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBankAndPersonDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BankAndPersonDetail = New BankAndPersonDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class frmCAStopChequeDet
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmCAStopChequeDet))
        ...
        Me.cmbType.Location = New System.Drawing.Point(464, 16)
        ...
        Me.btnCancel.Location = New System.Drawing.Point(648, 443)
        ...
        Me.lvDepositedCheques.Location = New System.Drawing.Point(8, 105)
        ...
        Me.lvDepositedCheques.TabIndex = 116
        ...
        Me.lblMessage.Location = New System.Drawing.Point(8, 81)
        ...
        Me.Name = "frmCAStopChequeDet"
        Me.ShowInTaskbar = False
        Me.Text = "CAStopChequeDet"
    ...
    Public Function fnGetStopPayDet() As Boolean
        ...
        Try
            While intCount < dvItems.Count
                ...
                lstvItems = lvDepositedCheques.Items.Add(dvItems.Item(intCount).Item("CAccountNo"))
...
#Region "Events"
    ...
    Private Sub frmSBStopChequeDet_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If objCAAccount.fnCaChqStopPayDet Then
            dvItems = New DataView(objCAAccount.ChqStopDet, strFilter, "CAccountNo", DataViewRowState.OriginalRows)
            fnGetStopPayDet()
        End If
...
#End Region
    ...
    Private Sub cmbType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbType.SelectedIndexChanged
        ...
        ElseIf cmbType.SelectedItem = "CAccountNo" Then
            dtpChequeDepDate.Visible = False
            btnSearch.Visible = False
            txtSearch.Visible = True
    ...
    Private Sub lvDepositedCheques_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvDepositedCheques.DoubleClick
        ...
        Dim objStopPay As New frmCAChequeStopPay

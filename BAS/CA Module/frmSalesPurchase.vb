...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmSalesPurchase))
        ...
        Me.txtLiabilityTotal.Font = New System.Drawing.Font("Verdana", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.txtLiabilityTotal.Size = New System.Drawing.Size(120, 15)
        ...
        Me.txtAssetTotal.Font = New System.Drawing.Font("Verdana", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.txtAssetTotal.Size = New System.Drawing.Size(120, 15)
        ...
        Me.lblMessage.Location = New System.Drawing.Point(616, 24)
        ...
        Me.lvLiability.Location = New System.Drawing.Point(16, 96)
        Me.lvLiability.Name = "lvLiability"
        Me.lvLiability.Size = New System.Drawing.Size(480, 408)
        ...
        Me.lvAsset.Size = New System.Drawing.Size(480, 408)
        ...
        Me.Name = "frmSalesPurchase"
        Me.ShowInTaskbar = False
        Me.Text = "frmSalesPurchase"
...
#Region "Global Variables"
    ...
    'Dim objGroup As New clsGroups11
    'Dim objLedger As New clsLedger11
#End Region

#Region "Code to Create Instance Object"

    Private Shared m_FormDefInstance As frmSalesPurchase
    Private Shared m_InitializingDefInstance As Boolean

    Public Shared Property DefInstance() As frmSalesPurchase
        Get
            If m_FormDefInstance Is Nothing OrElse m_FormDefInstance.IsDisposed Then
                m_InitializingDefInstance = True
                m_FormDefInstance = New frmSalesPurchase
                m_InitializingDefInstance = False
            End If
            DefInstance = m_FormDefInstance
        End Get
        Set(ByVal Value As frmSalesPurchase)
...
#Region "Sub Routines"
    ...
    Private Overloads Sub sbLoadExpanded()
        ...
        If objGroup.fnGetGroupsList() Then      'Get Groups List
            ...
            dvGroups.RowFilter = "Nature='T'"       'Get Liability Groups
            ...
            intCounter = 0
            intCountLedgers = 0
            dvGroups.RowFilter = "Nature='T'"       'Get Asset Groups
            While intCounter < dvGroups.Count       'for each Asset group
                ...
                If dvLedgers.Count > 0 Then     'if the Group has Ledgers then only display the Group 
                    ...
                    While intCountLedgers < dvLedgers.Count     'for each Ledger belong to the Group
                        ...
                        lvItem.SubItems.Add(dvLedgers.Item(intCountLedgers).Item("LedgerNo"))
                        lvItem.SubItems.Add(dvLedgers.Item(intCountLedgers).Item("Name"))
                        lvItem.SubItems.Add(Abs(dvLedgers.Item(intCountLedgers).Item("Receipt")))
        ...
        'If objLedger.fnGetLedgerDetails(42) Then
        'If objLedger.fnGetLedgerDetails(52) Then
        '    objDT = objLedger.LedgerTable
...
#Region " Events"
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        objReportViewer.CrystalReportViewer1.ReportSource = Application.StartupPath & "/../Reports/Trading.rpt"

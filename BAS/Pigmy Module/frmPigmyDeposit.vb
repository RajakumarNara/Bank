...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmPigmyDeposit))
        ...
        Me.txtPGName.Location = New System.Drawing.Point(112, 64)
        ...
        Me.txtNarration.Location = New System.Drawing.Point(112, 160)
        ...
        Me.txtAmount.Location = New System.Drawing.Point(112, 96)
        ...
        Me.txtRefNo.Location = New System.Drawing.Point(112, 128)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(376, 120)
        ...
        Me.btnDeposit.Location = New System.Drawing.Point(376, 216)
        ...
        Me.btnCancel.Location = New System.Drawing.Point(504, 216)
        ...
        Me.dtpDepositDate.Location = New System.Drawing.Point(440, 16)
        ...
        Me.Label9.Location = New System.Drawing.Point(376, 48)
        ...
        Me.lblBalance.Location = New System.Drawing.Point(440, 48)
        ...
        Me.ClientSize = New System.Drawing.Size(664, 268)
        ...
        Me.Name = "frmPigmyDeposit"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "BNN Collection"
...
#Region "Functions"
    ...
    Function fnGenerateVoucher(ByVal objTrans As IDbTransaction) As Boolean
        ...
        objPGAccount.fnPGtransactionEnter(Trim(txtPGAccNo.Text), dtpDepositDate.Value, "BNNC by account  " & txtPGAccNo.Text & txtNarration.Text, Trim(txtAmount.Text), 0, Trim(txtAmount.Text), txtRefNo.Text, lngVoucherNo, "Cash", 0, cmbAGNo.SelectedItem.col1, objTrans)

        'voucher details
        fnVoucherEnterMain(lngVoucherNo, 2, txtPGAccNo.Text, txtRefNo.Text, dtpDepositDate.Value, txtAmount.Text, "BNNC by account" & txtNarration.Text & txtPGAccNo.Text, lngSlNo, "Y", objTrans)

        'Credit accounts
        fnVoucherEnterSub(lngVoucherNo, 2, txtPGAccNo.Text, dtpDepositDate.Value, "BNNC by account " & txtPGAccNo.Text & txtNarration.Text, "To", 28, 0, Val(txtAmount.Text), 1, "Y", objTrans)

        'Debit accounts 
        fnVoucherEnterSub(lngVoucherNo, 2, " ", dtpDepositDate.Value, "BNNC by account " & txtPGAccNo.Text & txtNarration.Text, "By", 1, Val(txtAmount.Text), 0, 2, "Y", objTrans)
            ...
            If fnCheck() Then
                If fnCheckRefNo() = False Then
                    If fnSetData() Then
                        ...
                        fnLogEntry(pbUserId, "BNNC by " & txtPGAccNo.Text & " Amount " & txtAmount.Text, Date.Now, "Transaction Collection", objTrans)
                        objTrans.Commit()
